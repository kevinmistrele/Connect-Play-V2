...
export interface CntCommandProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntcommandVariants> {}

const CntCommand = React.forwardRef<HTMLDivElement, CntCommandProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntcommandVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntCommand.displayName = "CntCommand";

export { CntCommand, cntcommandVariants };