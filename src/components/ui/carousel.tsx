...
export interface CntCarouselProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntcarouselVariants> {}

const CntCarousel = React.forwardRef<HTMLDivElement, CntCarouselProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntcarouselVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntCarousel.displayName = "CntCarousel";

export { CntCarousel, cntcarouselVariants };