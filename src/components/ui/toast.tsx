...
export interface CntToastProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cnttoastVariants> {}

const CntToast = React.forwardRef<HTMLDivElement, CntToastProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cnttoastVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntToast.displayName = "CntToast";

export { CntToast, cnttoastVariants };