...
export interface CntDialogProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntdialogVariants> {}

const CntDialog = React.forwardRef<HTMLDivElement, CntDialogProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntdialogVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntDialog.displayName = "CntDialog";

export { CntDialog, cntdialogVariants };