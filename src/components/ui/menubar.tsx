...
export interface CntMenubarProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntmenubarVariants> {}

const CntMenubar = React.forwardRef<HTMLDivElement, CntMenubarProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntmenubarVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntMenubar.displayName = "CntMenubar";

export { CntMenubar, cntmenubarVariants };