...
export interface CntFormProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntformVariants> {}

const CntForm = React.forwardRef<HTMLDivElement, CntFormProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntformVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntForm.displayName = "CntForm";

export { CntForm, cntformVariants };