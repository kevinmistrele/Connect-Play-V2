...
export interface CntSelectProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntselectVariants> {}

const CntSelect = React.forwardRef<HTMLDivElement, CntSelectProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntselectVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntSelect.displayName = "CntSelect";

export { CntSelect, cntselectVariants };