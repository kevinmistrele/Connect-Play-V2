...
export interface CntSkeletonProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntskeletonVariants> {}

const CntSkeleton = React.forwardRef<HTMLDivElement, CntSkeletonProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntskeletonVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntSkeleton.displayName = "CntSkeleton";

export { CntSkeleton, cntskeletonVariants };