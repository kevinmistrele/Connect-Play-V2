...
export interface CntDrawerProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntdrawerVariants> {}

const CntDrawer = React.forwardRef<HTMLDivElement, CntDrawerProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntdrawerVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntDrawer.displayName = "CntDrawer";

export { CntDrawer, cntdrawerVariants };