...
export interface CntTabsProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cnttabsVariants> {}

const CntTabs = React.forwardRef<HTMLDivElement, CntTabsProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cnttabsVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntTabs.displayName = "CntTabs";

export { CntTabs, cnttabsVariants };