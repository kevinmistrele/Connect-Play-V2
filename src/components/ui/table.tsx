...
export interface CntTableProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cnttableVariants> {}

const CntTable = React.forwardRef<HTMLDivElement, CntTableProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cnttableVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntTable.displayName = "CntTable";

export { CntTable, cnttableVariants };