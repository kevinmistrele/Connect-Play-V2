...
export interface CntCalendarProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntcalendarVariants> {}

const CntCalendar = React.forwardRef<HTMLDivElement, CntCalendarProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntcalendarVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntCalendar.displayName = "CntCalendar";

export { CntCalendar, cntcalendarVariants };