...
export interface CntSheetProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntsheetVariants> {}

const CntSheet = React.forwardRef<HTMLDivElement, CntSheetProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntsheetVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntSheet.displayName = "CntSheet";

export { CntSheet, cntsheetVariants };