...
export interface CntChartProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntchartVariants> {}

const CntChart = React.forwardRef<HTMLDivElement, CntChartProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntchartVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntChart.displayName = "CntChart";

export { CntChart, cntchartVariants };