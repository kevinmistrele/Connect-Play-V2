...
const cntseparatorVariants = cva(
...
export interface CntSeparatorProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntseparatorVariants> {}

const CntSeparator = React.forwardRef<HTMLDivElement, CntSeparatorProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntseparatorVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntSeparator.displayName = "CntSeparator";

export { CntSeparator, cntseparatorVariants };