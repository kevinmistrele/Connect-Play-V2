...
const cntaccordionVariants = cva(
...
export interface CntAccordionProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cntaccordionVariants> {}

const CntAccordion = React.forwardRef<HTMLDivElement, CntAccordionProps>(
  ({ className, variant, size, ...props }, ref) => {
    return (
      <div
        className={cn(cntaccordionVariants({ variant, size }), className)}
        ref={ref}
        {...props}
      />
    );
...
CntAccordion.displayName = "CntAccordion";

export { CntAccordion, cntaccordionVariants };